...
if (isset($_POST["submit"]) && $_POST["submit"] == "AddUser" && isset($_POST["user"]) && strlen($_POST["user"]) > 0 && isset($_POST["pass"]) && strlen($_POST["pass"]) > 0) {
...
<html>
    ...
    <body>              
        <div class="jumbotron text-center">
            <h1><?php echo "ICA03 Settings:{$_SESSION["user"]}" ?></h1>      
        </div>
        <a href="../">Home</a>
